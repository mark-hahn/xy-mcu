...
#define SPI_SS_TRIS       TRISA7 // SPI Slave Select input
#define SPI_CLK_TRIS      TRISC3 // SPI Clock input
#define SPI_DATA_IN_TRIS  TRISC4 // SPI Data input
#define SPI_DATA_OUT_TRIS TRISC5 // SPI Data output
#define CCP1_TRIS         TRISB4 // CCP 1 pin output 
#define CCP2_TRIS         TRISC2 // CCP 2 pin output 
...
#define CCP1_LAT          LATB4  // CCP 1 pin latch
#define CCP2_LAT          LATC2  // CCP 2 pin latch 
...
#define CCP1_PPS         RB4PPS  // CCP 1 pin (step) output => B4
#define CCP2_PPS         RC2PPS  // CCP 2 pin (step) output => C2
